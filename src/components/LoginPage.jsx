...
import { ShieldCheck, Lock, Eye, EyeOff, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 text-white">
      <div className="w-full max-w-sm space-y-10">
        ...
        {/* Card */}
        <div className={`bg-[#0A0A0A] border rounded-[2rem] p-8 transition-all duration-300 ${isError ? 'border-red-500/50 shadow-red-500/10 shadow-lg' : 'border-white/5'}`}>
          <form onSubmit={handleUnlock} className="space-y-6">
            <div className="space-y-2">
              ...
              {isError && (
                <p className="text-red-400 text-xs ml-1 animate-pulse">Galat key! Dobara try karo.</p>
              )}
            </div>
